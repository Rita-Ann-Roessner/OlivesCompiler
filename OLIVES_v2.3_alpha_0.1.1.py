...
print("OLIVES_v2.0_dev0.0.3.9.5.py is written by Kasper Busk Pedersen, February 26th 2024.")
...
def user_input():
    ...
    parser.add_argument('--ss_cutoff', type=float, default=0.355, help='Cutoff distance for generation of the secondary network (and quaternary between backbone beads). Do not decrease, incease only if an important HB pair is beyond the cutoff (default=0.355).')
    parser.add_argument('--ts_cutoff', type=float, default=0.55, help='Cutoff distance for generation of the tertiary network (and quaternary between backbone-sidecahin and sidechain-sidechain pairs). Do not decrease, incease only if an important HB pair is beyond the cutoff (default=0.55).')
    parser.add_argument('--ss_scaling', type=float, default=0.5, help='Scaling of the secondary structure OLIVES bonds. Recommended range [0.2-0.4] (default=0.3).')
    parser.add_argument('--ts_scaling', type=float, default=0.8, help='Scaling of the tertiary structure OLIVES bonds. Recommended range [0.7-0.9] (default=0.8).')
    parser.add_argument('--qs_scaling', type=str, default='{}', help='Scaling of the quaternary bonds between .pdb chain indices (chains must have different names in the pdb file format). Format is a dictionary of chain index tuples with associated scaling value. E.g. in a protein with chain A,B,C the input {(0,1):0.7,(0,2):0.5,(1,2):0.2} will scale quaternary bonds between chain A and B by 0.7, A and C by 0.5, and B and C by 0.2. The tuple must be sorted.')
    parser.add_argument('--unique_pair_scaling', type=str, default="1.0", help='Multistate mode: Scaling of the unique contacts to each conformation, provided as a comma-separated sting e.g. "0.5,0.75". Shared contacts between conformations have their distances averaged.')
    parser.add_argument('--redefine_repulsive_backbone', type=bool, default=False, help='Experimental feature: Redefines sigma for backbone bead pairs which distances are below the r_min of the SP1-SP1 interaction. This has a performance cost and no obvious improvement on RMSFs (default=False).')
    parser.add_argument('--extend_itp', type=bool, default=True, help='Extend the protein topology with the Go-like model (default=True).')
...
quaternary_energy_scaling = eval(args.qs_scaling)  #Is multiplied with the relative hbond energies of bonds between chains  
unique_pair_scaling = [float(i) for i in list(args.unique_pair_scaling.split(","))]  #[kJ/mol] - Is multiplied with the relative hbond energies of conformational unique HBs when providing multiple conformations
harm_k = 700 #Used for visualization, but could be set and used with the VMD .itp if you want to test OLIVES as an elastic network
SP1_SP1_sigma = 0.41
SP1_SP1_epsilon = 3.07
silent = args.silent
...
hbond_dict = {"GLY":{"C":[[0,0],["None","None"]],"CA":[[0,0],["None","None"]],"O":[[1,0],["AMA","None"]],"N":[[0,1],["None","AMD"]]},
              "ALA":{"C":[[0,0],["None","None"]],"CA":[[0,0],["None","None"]],"O":[[1,0],["AMA","None"]],"N":[[0,1],["None","AMD"]],"SC1":[[0,0],["None","None"]]},
              "CYS":{"C":[[0,0],["None","None"]],"CA":[[0,0],["None","None"]],"O":[[1,0],["AMA","None"]],"N":[[0,1],["None","AMD"]],"SC1":[[1,1],["KEA","HYD"]]},
              "CYP":{"C":[[0,0],["None","None"]],"CA":[[0,0],["None","None"]],"O":[[1,0],["AMA","None"]],"N":[[0,1],["None","AMD"]],"SC1":[[1,1],["KEA","HYD"]],"C1":[[0,0],["None","None"]],"C2":[[0,0],["None","None"]],"C3":[[0,0],["None","None"]],"C4":[[0,0],["None","None"]]},
              "VAL":{"C":[[0,0],["None","None"]],"CA":[[0,0],["None","None"]],"O":[[1,0],["AMA","None"]],"N":[[0,1],["None","AMD"]],"SC1":[[0,0],["None","None"]]},
              "LEU":{"C":[[0,0],["None","None"]],"CA":[[0,0],["None","None"]],"O":[[1,0],["AMA","None"]],"N":[[0,1],["None","AMD"]],"SC1":[[0,0],["None","None"]]},
              "ILE":{"C":[[0,0],["None","None"]],"CA":[[0,0],["None","None"]],"O":[[1,0],["AMA","None"]],"N":[[0,1],["None","AMD"]],"SC1":[[0,0],["None","None"]]},
              "MET":{"C":[[0,0],["None","None"]],"CA":[[0,0],["None","None"]],"O":[[1,0],["AMA","None"]],"N":[[0,1],["None","AMD"]],"SC1":[[1,0],["KEA","None"]]},
              "PRO":{"C":[[0,0],["None","None"]],"CA":[[0,0],["None","None"]],"O":[[1,0],["AMA","None"]],"N":[[0,0],["None","None"]],"SC1":[[0,0],["None","None"]]},
              "ASN":{"C":[[0,0],["None","None"]],"CA":[[0,0],["None","None"]],"O":[[1,0],["AMA","None"]],"N":[[0,1],["None","AMD"]],"SC1":[[1,1],["AMA","AMD"]]}, 
              "GLN":{"C":[[0,0],["None","None"]],"CA":[[0,0],["None","None"]],"O":[[1,0],["AMA","None"]],"N":[[0,1],["None","AMD"]],"SC1":[[1,1],["AMA","AMD"]]}, 
              "ASP":{"C":[[0,0],["None","None"]],"CA":[[0,0],["None","None"]],"O":[[1,0],["AMA","None"]],"N":[[0,1],["None","AMD"]],"SC1":[[1,0],["KEA","None"]]},
              "ASPP":{"C":[[0,0],["None","None"]],"CA":[[0,0],["None","None"]],"O":[[1,0],["AMA","None"]],"N":[[0,1],["None","AMD"]],"SC1":[[1,1],["KEA","HYD"]]},
              "ASH":{"C":[[0,0],["None","None"]],"CA":[[0,0],["None","None"]],"O":[[1,0],["AMA","None"]],"N":[[0,1],["None","AMD"]],"SC1":[[1,1],["KEA","HYD"]]},
              "GLU":{"C":[[0,0],["None","None"]],"CA":[[0,0],["None","None"]],"O":[[1,0],["AMA","None"]],"N":[[0,1],["None","AMD"]],"SC1":[[1,0],["KEA","None"]]},
              "GLUP":{"C":[[0,0],["None","None"]],"CA":[[0,0],["None","None"]],"O":[[1,0],["AMA","None"]],"N":[[0,1],["None","AMD"]],"SC1":[[1,1],["KEA","HYD"]]},
              "GLH":{"C":[[0,0],["None","None"]],"CA":[[0,0],["None","None"]],"O":[[1,0],["AMA","None"]],"N":[[0,1],["None","AMD"]],"SC1":[[1,1],["KEA","HYD"]]},
              "THR":{"C":[[0,0],["None","None"]],"CA":[[0,0],["None","None"]],"O":[[1,0],["AMA","None"]],"N":[[0,1],["None","AMD"]],"SC1":[[1,1],["KEA","HYD"]]},
              "SER":{"C":[[0,0],["None","None"]],"CA":[[0,0],["None","None"]],"O":[[1,0],["AMA","None"]],"N":[[0,1],["None","AMD"]],"SC1":[[1,1],["KEA","HYD"]]},
              "LYS":{"C":[[0,0],["None","None"]],"CA":[[0,0],["None","None"]],"O":[[1,0],["AMA","None"]],"N":[[0,1],["None","AMD"]],"SC1":[[0,0],["None","None"]],"SC2":[[0,1],["None","IMD"]]},
              "LSN":{"C":[[0,0],["None","None"]],"CA":[[0,0],["None","None"]],"O":[[1,0],["AMA","None"]],"N":[[0,1],["None","AMD"]],"SC1":[[0,0],["None","None"]],"SC2":[[1,1],["IMA","IMD"]]},
              "LYN":{"C":[[0,0],["None","None"]],"CA":[[0,0],["None","None"]],"O":[[1,0],["AMA","None"]],"N":[[0,1],["None","AMD"]],"SC1":[[0,0],["None","None"]],"SC2":[[1,1],["IMA","IMD"]]},
              "ARG":{"C":[[0,0],["None","None"]],"CA":[[0,0],["None","None"]],"O":[[1,0],["AMA","None"]],"N":[[0,1],["None","AMD"]],"SC1":[[0,0],["None","None"]],"SC2":[[0,1],["None","IMD"]],"SC3":[[0,1],["None","IMD"]],"SC4":[[0,1],["None","IMD"]]}, # rita added SC3 and SC4
              "HIS":{"C":[[0,0],["None","None"]],"CA":[[0,0],["None","None"]],"O":[[1,0],["AMA","None"]],"N":[[0,1],["None","AMD"]],"SC1":[[0,0],["None","None"]],"SC2":[[0,1],["None","IMD"]],"SC3":[[1,0],["IMA","None"]]}, #assumed epsilon tautomer, but you should correct your pdb naming instead
              "HIE":{"C":[[0,0],["None","None"]],"CA":[[0,0],["None","None"]],"O":[[1,0],["AMA","None"]],"N":[[0,1],["None","AMD"]],"SC1":[[0,0],["None","None"]],"SC2":[[0,1],["None","IMD"]],"SC3":[[1,0],["IMA","None"]]}, 
              "HSE":{"C":[[0,0],["None","None"]],"CA":[[0,0],["None","None"]],"O":[[1,0],["AMA","None"]],"N":[[0,1],["None","AMD"]],"SC1":[[0,0],["None","None"]],"SC2":[[0,1],["None","IMD"]],"SC3":[[1,0],["IMA","None"]]},
              "HID":{"C":[[0,0],["None","None"]],"CA":[[0,0],["None","None"]],"O":[[1,0],["AMA","None"]],"N":[[0,1],["None","AMD"]],"SC1":[[0,0],["None","None"]],"SC2":[[1,0],["IMA","None"]],"SC3":[[0,1],["None","IMD"]]},
              "HSD":{"C":[[0,0],["None","None"]],"CA":[[0,0],["None","None"]],"O":[[1,0],["AMA","None"]],"N":[[0,1],["None","AMD"]],"SC1":[[0,0],["None","None"]],"SC2":[[1,0],["IMA","None"]],"SC3":[[0,1],["None","IMD"]]},
              "HSP":{"C":[[0,0],["None","None"]],"CA":[[0,0],["None","None"]],"O":[[1,0],["AMA","None"]],"N":[[0,1],["None","AMD"]],"SC1":[[0,0],["None","None"]],"SC2":[[0,1],["None","IMD"]],"SC3":[[0,1],["None","IMD"]]},
              "HIP":{"C":[[0,0],["None","None"]],"CA":[[0,0],["None","None"]],"O":[[1,0],["AMA","None"]],"N":[[0,1],["None","AMD"]],"SC1":[[0,0],["None","None"]],"SC2":[[0,1],["None","IMD"]],"SC3":[[0,1],["None","IMD"]]},
              "PHE":{"C":[[0,0],["None","None"]],"CA":[[0,0],["None","None"]],"O":[[1,0],["AMA","None"]],"N":[[0,1],["None","AMD"]],"SC1":[[0,0],["None","None"]],"SC2":[[1,0],["PIA","None"]],"SC3":[[1,0],["PIA","None"]]},
              "TYR":{"C":[[0,0],["None","None"]],"CA":[[0,0],["None","None"]],"O":[[1,0],["AMA","None"]],"N":[[0,1],["None","AMD"]],"SC1":[[0,0],["None","None"]],"SC2":[[1,0],["PIA","None"]],"SC3":[[1,0],["PIA","None"]],"SC4":[[1,1],["KEA","HYD"]]},
              "TRP":{"C":[[0,0],["None","None"]],"CA":[[0,0],["None","None"]],"O":[[1,0],["AMA","None"]],"N":[[0,1],["None","AMD"]],"SC1":[[0,0],["None","None"]],"SC2":[[0,1],["None","IND"]],"SC3":[[0,0],["None","None"]],"SC4":[[1,0],["PIA","None"]],"SC5":[[1,0],["PIA","None"]]}}
...
##### FUNCTIONS #####
def knowledge_based_checks(cut_pairs,cut_dists,filters,SP1_SP1_sigma,silent):
    #Unpack filters
    ...
    for i,pair in enumerate(cut_pairs):
        if a_ndx_to_res_name[pair[0]] == 'CYS' and a_ndx_to_res_name[pair[1]] == 'CYS':
            if a_ndx_to_bead_name[pair[0]] == 'SC1' and a_ndx_to_bead_name[pair[1]] == 'SC1':
                if cut_dists[i] < 0.3:
                    cys_bridges.append((a_ndx_to_res_ndx[pair[0]],a_ndx_to_res_ndx[pair[1]]))
    ...
    for i,pair in enumerate(cut_pairs):
        ...
        if a_ndx_to_bead_name[pair[0]] == 'C' and a_ndx_to_bead_name[pair[1]] == 'C':
            if not a_ndx_to_res_ndx[pair[1]] == (a_ndx_to_res_ndx[pair[0]]+1):
                if cut_dists[i] < np.power(2,1/6)*SP1_SP1_sigma:
                    pairs_repulsive.append(pair)
                    dists_repulsive.append(cut_dists[i])

        #Rules for the secondary network
        if a_ndx_to_bead_name[pair[0]] == 'C' or a_ndx_to_bead_name[pair[1]] == 'C' or a_ndx_to_bead_name[pair[0]] == 'CA' or a_ndx_to_bead_name[pair[1]] == 'CA':
            continue  #Remove pairs containing non-hydrogen bonding backbone beads
        #Rules for the secondary network
        if (a_ndx_to_bead_name[pair[0]] == 'O' and a_ndx_to_bead_name[pair[1]] == 'N') or (a_ndx_to_bead_name[pair[0]] == 'N' and a_ndx_to_bead_name[pair[1]] == 'O'):
            #Rules for the secondary network
        ...
        if a_ndx_to_bead_name[pair[0]] == 'O' or a_ndx_to_bead_name[pair[1]] == 'O' or a_ndx_to_bead_name[pair[0]] == 'N' or a_ndx_to_bead_name[pair[1]] == 'N':
            ...
            if a_ndx_to_res_ndx[pair[0]]+2 == (a_ndx_to_res_ndx[pair[1]]):
                continue # exclude BB <-> sidechain+2 hbonds

        #Exclude bonds within cys bridges
        for res_tuple in cys_bridges:
            if a_ndx_to_res_ndx[pair[0]] == res_tuple[0] and a_ndx_to_res_ndx[pair[1]] == res_tuple[1]:
                continue
            if a_ndx_to_res_ndx[pair[1]] == res_tuple[0] and a_ndx_to_res_ndx[pair[0]] == res_tuple[1]:
                continue
    ...
    return np.array(pairs_secondary),np.array(dists_secondary),np.array(pairs_repulsive),np.array(dists_repulsive),np.array(pairs_tertiary),np.array(dists_tertiary)
...
def combine_and_format_potentials(pairs_dict,networktype,unique_pairs,unique_pair_scaling,energy_scaling,quaternary_energy_scaling,filters):
    ...
    for pair, dist_energy in pairs_dict.items():
        ...
        if networktype == "repulsive":
            ...
            HB_energy = np.array(dist_energy)[0,1]
...
all_repulsive_pairs = []
all_repulsive_pairs_dists_energies = []
all_tertiary_pairs = []
...
for p,pdb_CG in enumerate(pdbs_CG):
    ...
    secondary_pairs,secondary_dists,repulsive_pairs,repulsive_dists,tertiary_pairs,tertiary_dists = knowledge_based_checks(cut_pairs,cut_dists,filters,SP1_SP1_sigma,silent)

    repulsive_pairs = [(pair[0],pair[1]) for pair in repulsive_pairs]
    repulsive_pairs_dists_energies = [[(pair[0],pair[1]),repulsive_dists[i],SP1_SP1_epsilon] for i,pair in enumerate(repulsive_pairs)]
    ...
    #We now impose that the secondary network can only have two HBs for each bead by performing a maximum weight matching (only one pass for new martini 3 protein model)
    if not silent:
    ...
    matched_secondary_network_pass1 = nx.max_weight_matching(secondary_graph_pass1,maxcardinality=False)
    ...
    #A second round of weighted pair matching is needed because subgraphs with an odd number of verticies cannot be fully paired, leaving gaps, this round fixes that
    remaining_pairs1 = []
    for pair in list(set(checked_secondary_pairs) - set(matched_secondary_pairs_pass1)):
        if pair[0] in flat_matched_secondary_pairs_pass1 or pair[1] in flat_matched_secondary_pairs_pass1:
            continue
        remaining_pairs1.append(pair)
    ...
    matched_secondary_network_pass2 = nx.max_weight_matching(secondary_graph_pass2,maxcardinality=True)
    

    matched_secondary_pairs_pass2 = [tuple(sorted(pair)) for pair in matched_secondary_network_pass2]
    
    matched_secondary_pairs = sorted([tuple(sorted(pair)) for pair in matched_secondary_pairs_pass1+matched_secondary_pairs_pass2])
    ...
    for p in remaining_pairs:
        if a_ndx_to_res_name[p[0]] == "GLN" or a_ndx_to_res_name[p[0]] == "ASN" or a_ndx_to_res_name[p[0]] == "ARG":
            if a_ndx_to_bead_name[p[0]] == 'O' or a_ndx_to_bead_name[p[0]] == 'N': #only select the sidechain beads
                continue
            elif p[1] in flat_matched_tertiary_pairs_pass1:
                if a_ndx_to_bead_name[p[1]] == 'O' or a_ndx_to_bead_name[p[1]] == 'N': # if the backbone bead is already bonded in the first round, do not consider it again
                    continue
                elif a_ndx_to_res_name[p[1]] == "GLN" or a_ndx_to_res_name[p[1]] == "ASN" or a_ndx_to_res_name[p[1]] == "ARG":
                    asn_gln_arg_pairs.append(p) # if the sidechain bead is already bonded in the first round, only consider GLN, ASN and ARG again
                else:
                    continue
            else:
                asn_gln_arg_pairs.append(p) # includes sidechain bead to non-bonded BB beads

        if a_ndx_to_res_name[p[1]] == "GLN" or a_ndx_to_res_name[p[1]] == "ASN" or a_ndx_to_res_name[p[1]] == "ARG":
            if a_ndx_to_bead_name[p[1]] == 'O' or a_ndx_to_bead_name[p[1]] == 'N': #only select the sidechain beads
                continue
            elif p[0] in flat_matched_tertiary_pairs_pass1:
                continue #if the partner was already paired, do not consider it. The previous rules have already covered side chain - side chain GLN, ASN pairs
            else:
                asn_gln_arg_pairs.append(p) # includes sidechain bead to non-bonded BB beads
    ...
    all_repulsive_pairs.append(repulsive_pairs)  
    all_repulsive_pairs_dists_energies.append(repulsive_pairs_dists_energies)
    ...
    if not silent:
        ...
        print("Corrected sigma of backbone SP1-SP1 pairs: {}".format(len(repulsive_pairs)))
...
repulsive_pair_multiples_dict = construct_pair_multiples_dict(all_repulsive_pairs,all_repulsive_pairs_dists_energies)
...
repulsive_harm_potentials,repulsive_LJ_potentials,repulsive_exclusions,repulsive_quaternary_pair_info = combine_and_format_potentials(repulsive_pair_multiples_dict,"repulsive",None,None,None,None,filters)
...
if args.extend_itp: 
    ...
    with open(itp_CG, "a") as f:
        if args.redefine_repulsive_backbone:
            output = ['; OLIVES exclusions for repulsive LJ 1-4 pairs'.split()] + ['[ exclusions ]'.split()] + repulsive_exclusions + [[""]]
            for line in output:
                f.write("{}\n".format(' '.join(line)))
            output = ['; OLIVES secondary as LJ 1-4 pairs'.split()] + ['[ pairs ]'.split()] + secondary_LJ_potentials + [[""]]
            for line in output:
                f.write("{}\n".format(' '.join(line)))
            output = ['; OLIVES repulsive as LJ 1-4 pairs'.split()] + repulsive_LJ_potentials + [[""]]
            for line in output:
                f.write("{}\n".format(' '.join(line)))
...
if args.write_separate_itp:
    ...
    if args.redefine_repulsive_backbone: 
        with open("Exclusions_repulsive_"+itp_CG,'w') as mo:
            output = [[""]] + ['; OLIVES exclusions for repulsive LJ 1-4 pairs'.split()] + ['[ exclusions ]'.split()] + repulsive_exclusions + [[""]]
            for line in output:
                mo.write("{}\n".format(' '.join(line)))
        print("Wrote: {}".format("Exclusions_repulsive_"+itp_CG))
        
        with open("LJ_repulsive_"+itp_CG,'w') as mo:
            output = [[""]] + ['; OLIVES repulsive as LJ 1-4 pairs'.split()] + ['[ pairs ]'.split()] + repulsive_LJ_potentials + [[""]]
            for line in output:
                mo.write("{}\n".format(' '.join(line)))
        print("Wrote: {}".format("LJ_repulsive_"+itp_CG))
...
if not silent:
    ...
    print('This could happen if a protein complex dissociates or a protein unfolds. The 2 nm distance cutoff for domains in -rdd is where a LJ potential with energy minimum distance at 0.55 nm goes to ~0.')
    ...
    print("OLIVES does not require the -dssp martinize2 flag for secondary structure dihedral restraints")
    print("IMPORTANTLY you should instead use '-ss CCCCCC (one letter per residue)' in your martinize2 input")
    print("Although one can opt to restrain the secondary structure using the martinize2 -dssp flag at the cost of overstabilized secondary structure. In that case do not use the -ss flag.")
